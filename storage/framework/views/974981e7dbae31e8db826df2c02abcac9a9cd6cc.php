...
<head>
  ...
  <title data-tid="elements_examples.meta.title">Laravel Stripe Example</title>
  ...
  <script src="<?php echo e(URL::asset('js/index.js')); ?>" data-rel-js></script>

  <link href="https://fonts.googleapis.com/css?family=Roboto" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css?family=Quicksand" rel="stylesheet">
  <link href="https://fonts.googleapis.com/css?family=Source+Code+Pro" rel="stylesheet">

  <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('css/base.css')); ?>" data-rel-css="" />

  <!-- CSS for each example: -->
  <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('css/example2.css')); ?>" data-rel-css="" />
</head>
<body>
      ...
      <div class="cell example example2" id="example-2">
        ...
        <div class="caption">
          <a class="source" href="https://github.com/stripe/elements-examples/#example-2">
            ...
            <a href="/" data-tid="elements_examples.caption.view_source">View source on GitHub</a>
          </a>
        </div>
      </div>
...
</html><?php /**PATH C:\xampp\htdocs\laravel-stripe\resources\views/index.blade.php ENDPATH**/ ?>